...
## Q1
os.system("python run_hw3_dqn.py --env_name PongNoFrameskip-v4 --exp_name q1")
...
## Q3
os.system("python run_hw3_dqn.py --env_name PongNoFrameskip-v4 --double_q --exp_name q3_hparam1")
os.system("python run_hw3_dqn.py --env_name PongNoFrameskip-v4 --double_q --batch_size 64 --exp_name q3_hparam2")
os.system("python run_hw3_dqn.py --env_name PongNoFrameskip-v4 --double_q --batch_size 128 --exp_name q3_hparam3")
