...
class PGAgent(BaseAgent):
    ...
    def _discounted_return(self, rewards):
        ...
        discounts = np.array([self.gamma ** idx for idx in indices])
        ...
        list_of_discounted_returns = sum_of_discounted_rewards * np.ones_like(indices)
    ...
    def _discounted_cumsum(self, rewards):
        ...
        for start_time_index in range(len(rewards)): 
            ...
            discounts = np.array([self.gamma ** (idx - start_time_index) for idx in indices])
